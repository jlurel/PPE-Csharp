    ...
    public static class Passerelle
    {
        ...
        public static bool seConnecter()
        {
            ...
            laConnexion.ConnectionString = 
                "Data Source=WIN-S40NACGQ6GK;Initial Catalog=PPEgsb;Integrated Security = true; MultipleActiveResultSets = true";
        ...
        public static Produit getProduit(int unIdProduit)
        {
            ...
            SqlCommand laCommande = laConnexion.CreateCommand();
            laCommande.CommandType = System.Data.CommandType.Text;
            laCommande.CommandText = "select * from T_PRODUITLABO where PRO_ID = " + unIdProduit;
        ...
        public static Produit getProduit(String unLibelleProduit)
        {
            ...
            SqlCommand laCommande = laConnexion.CreateCommand();
            laCommande.CommandType = System.Data.CommandType.Text;
            laCommande.CommandText = "select * from T_PRODUITLABO where PRO_LIBELLE = '" + unLibelleProduit + "'";
            SqlDataReader leLecteurP = laCommande.ExecuteReader();
            if (leLecteurP.Read())
            {
        ...
        public static bool existeProduit(String unLibelleProduit)
        {
            bool trouve = false;
            SqlCommand laCommande = laConnexion.CreateCommand();
            laCommande.CommandText = "select * from T_PRODUITLABO where exists(select * from T_PRODUITLABO where PRO_LIBELLE = '" 
        ...
        {
            SqlCommand laCommande = laConnexion.CreateCommand();
            laCommande.CommandText = "insert into T_PRODUITLABO (PRO_LIBELLE) values ('" + unLibelleProduit + "')";
        ...
        public static void modifierProduit(int unIdProduit, String unLibelleProduit)
        {
            SqlCommand laCommande = laConnexion.CreateCommand();
            laCommande.CommandType = System.Data.CommandType.Text;
            laCommande.CommandText = "update T_PRODUITLABO set PRO_LIBELLE = '" + unLibelleProduit + "' where PRO_ID = " + unIdProduit;
            laCommande.ExecuteNonQuery();
        }
        ...
        public static void supprimerProduit(int unIdProduit)
        {
            SqlCommand laCommande = laConnexion.CreateCommand();
            laCommande.CommandType = System.Data.CommandType.Text;
            laCommande.CommandText = "delete from T_PRODUITLABO where PRO_ID = " + unIdProduit;
            laCommande.ExecuteNonQuery();
        }
        ...
        public static List<Produit> getLesCompetencesDispo(int unIdVisiteur)
        {
            ...
            laCommande.CommandType = System.Data.CommandType.Text;
            laCommande.CommandText = 
                "select * from T_PRODUITLABO where PRO_ID not in (select COM_IDPRODUIT from T_COMPETENCE where COM_IDVISITEUR =" 
                + unIdVisiteur + ")";
            SqlDataReader leLecteurP = laCommande.ExecuteReader();
            while (leLecteurP.Read())
            {
        ...
        public static List<Produit> getLesCompetencesDuVisiteur(int unIdVisiteur)
        {
            ...
            laCommande.CommandType = System.Data.CommandType.Text;
            laCommande.CommandText =
                "select * from T_PRODUITLABO where PRO_ID in (select COM_IDPRODUIT from T_COMPETENCE where COM_IDVISITEUR ="
                + unIdVisiteur + ")";
            SqlDataReader leLecteurP = laCommande.ExecuteReader();
            while (leLecteurP.Read())
            {
        ...
        public static DataTable getVisiteursParProduit()
        {
            ...
            laCommande.CommandType = System.Data.CommandType.Text;
            laCommande.CommandText = 
                "select count(COM_IDVISITEUR), PRO_LIBELLE from T_COMPETENCE, T_PRODUITLABO where PRO_ID = COM_IDPRODUIT group by PRO_LIBELLE";
            SqlDataReader leLecteurP = laCommande.ExecuteReader();
            while (leLecteurP.Read())
            {
        ...
        public static DataTable getVisiteursParAge()
        {
            ...
            laCommande.CommandText = "select tranche.range as [tranche age], count(*) as [nombre de visiteurs]"
                + "from( select case when(YEAR(GETDATE()) - YEAR(VIS_DATE_NAISSANCE)) between 0 and 19 then '20-'"
                + "when(YEAR(GETDATE()) - YEAR(VIS_DATE_NAISSANCE)) between 20 and 29 then '20-29'"
                + "when(YEAR(GETDATE()) - YEAR(VIS_DATE_NAISSANCE)) between 30 and 39 then '30-39'"
                + "when(YEAR(GETDATE()) - YEAR(VIS_DATE_NAISSANCE)) between 40 and 49 then '40-49'"
